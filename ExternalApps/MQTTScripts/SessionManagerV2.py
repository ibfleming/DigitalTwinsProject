...
replay_script     = "ReplayManager.py"
    ...
    if msg.topic == session_topic:
        ...
        if not in_session:
            if message == "Start":
                ...
                print(f"Publishing session UUID.")
                client.publish(uuid_topic, session_id, retain=True)
