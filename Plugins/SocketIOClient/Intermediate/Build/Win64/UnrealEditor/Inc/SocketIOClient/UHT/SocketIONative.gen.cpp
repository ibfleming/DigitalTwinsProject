...
<<<<<<< Updated upstream
	struct Z_CompiledInDeferFile_FID_Users_lee4219_Documents_UnrealProjects_2024_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lee4219_Documents_UnrealProjects_2024_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo[] = {
		{ ESIOConnectionCloseReason_StaticEnum, TEXT("ESIOConnectionCloseReason"), &Z_Registration_Info_UEnum_ESIOConnectionCloseReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1757064737U) },
		{ ESIOThreadOverrideOption_StaticEnum, TEXT("ESIOThreadOverrideOption"), &Z_Registration_Info_UEnum_ESIOThreadOverrideOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1274783653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lee4219_Documents_UnrealProjects_2024_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_2494281838(TEXT("/Script/SocketIOClient"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_lee4219_Documents_UnrealProjects_2024_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lee4219_Documents_UnrealProjects_2024_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo));
=======
	struct Z_CompiledInDeferFile_FID_Users_flem8015_Documents_Unreal_Projects_DigitalTwinsProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flem8015_Documents_Unreal_Projects_DigitalTwinsProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo[] = {
		{ ESIOConnectionCloseReason_StaticEnum, TEXT("ESIOConnectionCloseReason"), &Z_Registration_Info_UEnum_ESIOConnectionCloseReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1757064737U) },
		{ ESIOThreadOverrideOption_StaticEnum, TEXT("ESIOThreadOverrideOption"), &Z_Registration_Info_UEnum_ESIOThreadOverrideOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1274783653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flem8015_Documents_Unreal_Projects_DigitalTwinsProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_2494281838(TEXT("/Script/SocketIOClient"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_flem8015_Documents_Unreal_Projects_DigitalTwinsProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_flem8015_Documents_Unreal_Projects_DigitalTwinsProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo));
>>>>>>> Stashed changes
