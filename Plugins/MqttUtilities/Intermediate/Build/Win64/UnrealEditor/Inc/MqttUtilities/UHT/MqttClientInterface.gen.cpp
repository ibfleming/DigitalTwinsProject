...
void FOnMqttErrorDelegate_DelegateWrapper(const FScriptDelegate& OnMqttErrorDelegate, int32 code, const FString& message)
{
	...
	struct Z_CompiledInDeferFile_FID_Projects_DigitalTwinsProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Interface_MqttClientInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_DigitalTwinsProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Interface_MqttClientInterface_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_DigitalTwinsProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Interface_MqttClientInterface_h_1566023172(TEXT("/Script/MqttUtilities"),
		Z_CompiledInDeferFile_FID_Projects_DigitalTwinsProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Interface_MqttClientInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_DigitalTwinsProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Interface_MqttClientInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
